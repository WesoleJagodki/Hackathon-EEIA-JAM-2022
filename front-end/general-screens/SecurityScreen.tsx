            ...
            <View style={g_styles.container_app}>
                ...
                <Center>
                    ...
                    <VStack space={3} style={settings_styles.settings_list}>
                        ...
                        <HStack position={'relative'} left={-7} onTouchStart={() => {navigation.navigate('AchivementsScreen')}}><Image style={security_screen.shield} source={require("../image/shield.png")}/><DoubleImageButton text="Two-factor authentication"/></HStack>
