            ...
            <View style={g_styles.container_app}>
                ...
                <Center>
                    ...
                    <VStack space={3} style={settings_styles.settings_list}>
                        <HStack position={'relative'} left={-5}><Image style={security_screen.key} source={require("../image/key.png")}/><DoubleImageButton text="Change password"/></HStack>
                        <HStack position={'relative'} left={-7}><Image style={security_screen.shield} source={require("../image/shield.png")}/><DoubleImageButton text="Two-factor authentication"/></HStack>
                        <HStack position={'relative'} left={-8}><Image style={security_screen.questionmark} source={require("../image/help-circle.png")}/><DoubleImageButton text="Learn more about security"/></HStack>
                    </VStack>
